...
We did the same thing in uber pick up plots too. The only difference is that there's only one color in the plot. From the third graph we found that uber pickup locations are mainly in lower Manhattan and Brooklyn. 
...
The rush hour pick-up plot looks nice. The yellow cabs solely pick up customers in midtown and downtown Manhattan while the green cabs pick up customers in other areas of NYC.
...
For the rush hour drop off plot. I looks like both yellow cabs and green cabs drop people in every part of NYC with most people get off in Manhattan. Since the green points cover the yellow points, we may not clearly see the wide-spreaded drop-off locations for yellow cabs. But we can see imply from the fact that there are more yellow cabs in NYC, so the drop off locations should be wide-spreaded for yellow cabs as well.
...
For non-rush hour, the yellow cabs pick up customers mostly in Manhattan and JFK airport. Green cabs pick up customers all around the city.
